...
export default function LaRuelleDashboard() {
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">Suivi complet • {new Date().toLocaleDateString('fr-FR', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
            </div>
          </div>
        ...
        {tab === 'dashboard' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { label: '💰 CA du mois', value: kpis.totalCA, suffix: '', color: 'from-blue-600 to-blue-700', icon: '📊' },
                { label: '✅ Livrées', value: kpis.delivered, suffix: '', color: 'from-green-600 to-green-700', icon: '✓' },
                { label: '⏳ Pending', value: kpis.pending, suffix: '', color: 'from-orange-600 to-orange-700', icon: '⧗' },
              ].map((kpi, i) => (
                <div
                  key={i}
                  className={`bg-gradient-to-br ${kpi.color} p-6 rounded-xl text-white shadow-xl`}
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div
                  key={i}
                  className={`bg-gradient-to-br ${kpi.color} p-4 rounded-lg text-white shadow-lg`}
                >
          ...
          <div className="space-y-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center gap-2 font-medium whitespace-nowrap"
              >
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-900 text-white">
                    <tr>
                      <th className="px-4 py-3 text-left font-semibold">N° Cmd</th>
                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-900 text-white">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-center font-semibold">Initial</th>
                  ...
                  <tbody>
                    {stock.map((s, i) => {
                      ...
                      return (
                        <tr key={i} className={i % 2 ? 'bg-gray-50' : 'bg-white'}>
                          <td className="px-4 py-3 font-mono font-bold">{s.ref}</td>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl max-w-2xl w-full p-8 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={onClose} className="text-gray-500 hover:text-gray-700 p-1 hover:bg-gray-100 rounded">
            <X size={24} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 justify-end pt-4 border-t">
            ...
            <button
              type="submit"
              className="px-6 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 font-medium flex items-center gap-2"
            >
              ✓ Enregistrer
            </button>
          </div>
